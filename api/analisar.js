...
function buildPrompt(d) {
  return [
    ...
    ``,
    `Responda SOMENTE com JSON puro (sem nada mais, sem blocos de código):`,
    `{`,
    `  "resumo": "string",`,
    `  "urgencia": "alta",`,
    `  "urgencia_motivo": "string",`,
    `  "hipoteses": [{"titulo":"string","probabilidade":"alta","descricao":"string","indicadores":["string"]}],`,
    `  "timeline": [{"data":"string","titulo":"string","descricao":"string","cor":"red"}],`,
    ...
    `}`,
    ``,
    `Valores possíveis — urgencia: alta|media|baixa. probabilidade: alta|media|baixa. cor: red|amber|green|gray.`,
